...
namespace Framework::DX {
    ...
    public:
        ...
        DeviceResource(DXGI_FORMAT backBufferFormat = DXGI_FORMAT::DXGI_FORMAT_R8G8B8A8_UNORM,
            DXGI_FORMAT depthBufferFormat = DXGI_FORMAT::DXGI_FORMAT_D32_FLOAT, UINT flags = 0);
        /**
         * @brief デストラクタ
         */
        ~DeviceResource();
    ...
    public:
        ...
        ID3D12CommandAllocator* getCommandAllocator() const {
            return mCommandAllocators[mBackBufferIndex].Get();
        }
        /**
         * @brief コマンドリストを取得する
         */
        ...
        UINT getPreviousFrameIndex() const {
            return mBackBufferIndex == 0 ? BACK_BUFFER_COUNT - 1 : mBackBufferIndex - 1;
        }
        /**
