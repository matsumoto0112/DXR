...
namespace Framework::DX {
    ...
    */
    class ShaderTable : public GPUUploadBuffer {
        ...
        ShaderTable() { };
    public:
        ShaderTable(ID3D12Device* device, UINT shaderRecordNum, UINT shaderRecordSize, LPCWSTR name = nullptr)
            :mName(name) {
            mRecordSize = align(shaderRecordSize, D3D12_RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT);
