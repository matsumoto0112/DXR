...
namespace Framework::Camera {
    ...
    */
    ...
    public:
        ...
        * @brief コンストラクタ
        */
        Perspective(const Math::Vector3& position, const Math::Vector3& lookat, const Math::Vector3& up,
        ...
        * @brief 座標を設定する
        */
        void setPosition(const Math::Vector3& position) { mPosition = position; updateView(); }
        /**
        * @brief 座標を取得する
        */
        ...
        * @brief 注視点を設定する
        */
        void setLookAt(const Math::Vector3& lookat) { mLookAt = lookat; updateView(); }
        /**
        ...
        * @brief 上方向ベクトルを設定する
        */
        void setUpVector(const Math::Vector3& up) { mUpVector = up; updateView(); }
        /**
        * @brief 上方向ベクトルを取得する
        */
        ...
        * @brief 視野角を設定する
        */
        void setFov(const Math::Radians& fov) { mFov = fov; updateProj(); }
        /**
        * @brief 視野角を取得する
        */
        ...
        * @brief アスペクト比を設定する
        */
        void setAspectRatio(float aspect) { mAspect = aspect; updateProj(); }
        /**
        * @brief アスペクト比を取得する
        */
        ...
        * @brief 最近点までの距離を設定する
        */
        void setNearClip(float nearZ) { mNearClip = nearZ; updateProj(); }
        /**
        * @brief 最近点までの距離を取得する
        */
        ...
        * @brief 最遠点までの距離を設定する
        */
        void setFarClip(float farZ) { mFarClip = farZ; updateProj(); }
        /**
        * @brief 最遠点までの距離を設定する
        */
