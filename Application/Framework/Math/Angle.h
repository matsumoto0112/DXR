...
namespace Framework::Math {
    ...
    * @brief 加算演算子
    */
    inline Degrees operator+(const Degrees& deg1, const Degrees& deg2) { return Degrees(deg1) += deg2; }
    /**
    * @brief 加算演算子
    */
    ...
    * @brief 等価比較演算子
    */
    inline bool operator==(const Radians& rad1, const Radians& rad2) { return rad1.getRad() == rad2.getRad(); }
    /**
    * @brief 等価比較演算子
    */
    ...
    * @brief 加算演算子
    */
    inline Radians operator+(const Radians& rad1, const Radians& rad2) { return Radians(rad1) += rad2; }
    /**
    * @brief 加算演算子
    */
